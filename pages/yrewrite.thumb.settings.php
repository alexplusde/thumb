...
$field->setLabel(rex_i18n::rawMsg('thumb_config_hcti_username_label'));

$field = $form->addInputField('text', 'hcti_api_key', null, ["class" => "form-control"]);
$field->setLabel(rex_i18n::rawMsg('thumb_config_hcti_api_key_label'));
$field->setNotice(rex_i18n::rawMsg('thumb_config_hcti_api_key_notice'));
...
$field->setLabel(rex_i18n::rawMsg('thumb_config_fragment_label'));
$select = $field->getSelect();
